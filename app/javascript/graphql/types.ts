...
export type GenerateGeminiOrderMessageInput = {
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: InputMaybe<Scalars['String']['input']>;
  /** The order message ID that Gemini will be responding to */
  orderMessageId: Scalars['ID']['input'];
};

/** Autogenerated return type of GenerateGeminiOrderMessage. */
export type GenerateGeminiOrderMessagePayload = {
  __typename?: 'GenerateGeminiOrderMessagePayload';
  /** A unique identifier for the client performing the mutation. */
  clientMutationId?: Maybe<Scalars['String']['output']>;
  errors: Array<Error>;
  orderMessage?: Maybe<OrderMessage>;
...
export type Mutation = {
  ...
  generateGeminiOrderMessage?: Maybe<GenerateGeminiOrderMessagePayload>;
...
export type MutationGenerateGeminiOrderMessageArgs = {
...
export type Product = {
  ...
  createdAt: Scalars['ISO8601DateTime']['output'];
  id: Scalars['ID']['output'];
  stripeDefaultPriceId: Scalars['String']['output'];
  stripeDescription: Scalars['String']['output'];
  stripeImages: Array<Scalars['String']['output']>;
  stripeName: Scalars['String']['output'];
  stripePriceUnitAmount: Scalars['Int']['output'];
...
export type Subscription = {
  ...
  orderMessageReceived?: Maybe<OrderMessage>;
};


export type SubscriptionOrderMessageReceivedArgs = {
  orderId: Scalars['ID']['input'];
};
...
export type GetProductsQuery = { __typename?: 'Query', products: Array<{ __typename?: 'Product', stripeDefaultPriceId: string, stripePriceUnitAmount: number, stripeDescription: string, stripeImages: Array<string>, stripeName: string }> };
...
export type FetchOrdersQuery = { __typename?: 'Query', orders?: Array<{ __typename?: 'Order', id: string, status: OrderStatus, createdAt: string, updatedAt: string, amountTotal: number, guestEmail?: string | null, stripePaymentIntentId: string, stripeCheckoutSessionLineItems: Array<{ __typename?: 'OrderLineItem', name: string, quantity: number, imageUrl: string, unitAmount: number }>, user?: { __typename?: 'User', id: string, email: string } | null }> | null };
