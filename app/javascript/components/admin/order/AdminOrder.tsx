      ...
      {loading ? (
        ...
        <div className=" border-2 rounded p-4 bg-blue-700">
          ...
          <div className="grid grid-cols-2 gap-4 grid-rows-1">
            ...
            <p>{data?.order?.id}</p>
            <p className="justify-self-end font-bold text-right">User Email</p>
            <p>
              {data?.order?.user
            ...
            <p className="justify-self-end font-bold text-right">Created At</p>
            <p>{data?.order?.createdAt}</p>
            <p className="justify-self-end font-bold text-right">Order Items</p>
            <div>
