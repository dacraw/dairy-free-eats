        ...
        {getProductsLoading ? (
          ...
          <>
            ...
            <p className="mb-6 font-bold text-sm">
              ...
              "Submit", as it contains information regarding the information to
              be entered into the Stripe Checkout page in order to demo this
              process.
            </p>
            ...
            <div className="md:p-6">
              ...
              <div className="mb-6 pb-2 border-b-2">
                ...
                <ul className="list-disc ml-4">
                  <li>
                    Enter an email that you have access to if you want to
                    receive emails sent during the order process (this will be
                    pre-filled for you if you signed up on this app)
                  </li>
              ...
              <ul className="list-disc ml-4 mb-2">
                <li>
                  ...
                  pre-filled if you have an account on this app; otherwise,
                  enter any email you can receive messages to if you want to
                  demo the email functionality from the Stripe webhook
                  configuration of this app (if you don't care to receive the
                  emails, you can enter any arbitrary email formatted value such
                  as "test@demo.com")
                </li>
                <li>
                  <strong className="font-bold">Credit Card number:</strong>{" "}
                  4242 4242 4242 4242 (this is a test credit card number, feel
                  free to use any of the{" "}
                  <a
              ...
              <p className="text-sm">
                Please note that the checkout is using a test API key to
                simulate real transactions, so no charges will occur.
                Regardless,{" "}
                <strong className="font-bold">
